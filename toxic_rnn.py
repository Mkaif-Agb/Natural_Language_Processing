...
x = LSTM(128, return_sequences=True, activation='tanh', kernel_initializer='he_normal')(x)
x = LSTM(64, return_sequences=True, activation='tanh', kernel_initializer='he_normal')(x)
